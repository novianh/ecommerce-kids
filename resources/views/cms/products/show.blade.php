                        ...
                        @if ($product->gallery)
                            @foreach ($product->gallery as $item)
                                <div class="col-xl-1 col-md-3 col-4"> <img class="img-thumbnail" width="100%"
                                    ...
                                    <a href="{{route('gallery.edit', $item)}}" class=" text-success"><i class="fa fa-edit" data-toggle="modal"
                                    ...
                                    <a href="{{route('delete', $item->id)}}" class=" text-danger -sm mb-0"
                                        ...
                                        {{-- <form action="{{route('delete')}}" method="post">
                                            ...
                                            <button type="submit" onclick="notificationBeforeDelete(event, this) class="btn text-danger ml-2"><i class=" fa fa-trash"></i></button>
                                        </form> --}}
                                </div>
                            @endforeach
                        @endif
