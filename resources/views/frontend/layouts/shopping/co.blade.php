                  ...
                  <form class="needs-validation">
                     ...
                     <div class="row">
                        <div class="col-12 mb-1">
                           <div class="mb-3">
                              <label for="exampleFormControlTextarea1" class="form-label">Message <small class="text-secondary">(Opsional)</small></label>
                        ...
                        <div class=" col-12 mb-3">
                           ...
                           <small><a href="#" class="link align-items-center" id="style-2" data-replace="Let's go"
